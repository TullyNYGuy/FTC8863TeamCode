...
import org.firstinspires.ftc.teamcode.Lib.CenterStageLib.RobotHangTest;
import org.firstinspires.ftc.teamcode.Lib.CenterStageLib.RobotHangTestGamepad;
...
public class HangTest extends LinearOpMode {
    ...
    public RobotHangTest robot;
    public RobotHangTestGamepad gamepad;
...
//            telemetry.update();
        ...
        robot = new RobotHangTest(hardwareMap, telemetry, config, dataLog, DistanceUnit.CM, this);
        //field = new CenterStageField(PowerPlayPersistantStorage.getColorLocation());

        // create the robot and run the init for it
        robot.createRobot();
        gamepad = new RobotHangTestGamepad(gamepad1, gamepad2, robot);
