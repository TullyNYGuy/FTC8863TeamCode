...
import org.firstinspires.ftc.teamcode.Lib.PowerPlayLib.PowerPlayAutonomousVisionOneCycleParkWithSensor;
...
public class TestPowerPlayAutonomousWithSensor extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        autonomousStateMachine = new PowerPlayAutonomousVisionOneCycleParkWithSensor(robot, field, telemetry);
        ...
        while (opModeIsActive() && !autonomousStateMachine.isComplete()) {
            ...
            telemetry.addData("distance read = ",robot.distanceSensorForNormal.getDistance(DistanceUnit.INCH));
            telemetry.update();
            robot.update();
            idle();
        }
