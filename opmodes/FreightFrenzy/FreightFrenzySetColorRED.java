...
@Autonomous(name = "SET RED ALLIANCE", group = "AARun")


public class FreightFrenzySetColorRED extends LinearOpMode {
...
//        }
        ...
        while (opModeIsActive()) {
           ...
           // pipeline.processFrame(robot.webcam.)
            telemetry.addData(">", "Color set. Press Stop.");
            telemetry.update();
        ...
        telemetry.addData(">", "color set as Red");
        telemetry.update();
    }
