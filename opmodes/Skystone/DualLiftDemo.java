...
public class DualLiftDemo extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        extensionRetractionMechanismLeft.reset();
        extensionRetractionMechanismRight.reset();

        while(opModeIsActive() && !(extensionRetractionMechanismLeft.isResetComplete() && extensionRetractionMechanismRight.isResetComplete())) {
        ...
        extensionRetractionMechanismLeft.goToPosition(40.0, speed);
        extensionRetractionMechanismRight.goToPosition(40.0,speed);
        timerLeft.reset();
        timerRight.reset();
        ...
        extensionRetractionMechanismLeft.goToPosition(3, speed);
        extensionRetractionMechanismRight.goToPosition(3, speed);
        timerLeft.reset();
        timerRight.reset();
