...
@TeleOp(name = "ITD Test Max Velocity", group = "Test")
@Disabled

public class ITDFindMaxVelocity extends LinearOpMode {
...
//        MecanumCommands commands = new MecanumCommands();
        ...
        dataFile = new CSVDataFile("velocityTest");
        dataFile.headerStrings("time", "x", "y");
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad.getDrivingMode() == DrivingMode.ROBOT_CENTRIC) {
                ...
                robot.mecanumDrive.calculateMotorCommandsRobotCentric(
                        -1 * robot.robotModes.getDirectionSwapMultiplier(),
                        0 * robot.robotModes.getDirectionSwapMultiplier(),
                        0
                );
            }
...
//            }
            ...
            dataFile.writeData(timer.milliseconds(), robot.mecanumDrive.pose.position.x, robot.mecanumDrive.pose.position.y);
