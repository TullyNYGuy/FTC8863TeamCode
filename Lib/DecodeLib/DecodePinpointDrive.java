 ...
 */
@Config
public class DecodePinpointDrive extends DecodeMecanumDrive implements FTCRobotSubsystem {
    ...
    public DecodePinpointDrive(HardwareMap hardwareMap, Pose2d pose) {
