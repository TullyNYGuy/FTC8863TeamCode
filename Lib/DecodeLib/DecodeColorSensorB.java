 ...
 */
public class DecodeColorSensorB {
    ...
    // public so that its methods are accessible publicly
    ...
    public DecodeColorSensorB(HardwareMap hardwareMap, Telemetry telemetry, String name) {
        ...
        // access the color sensor through the sensor methods: decodeColorSensorB.sensor.whatever
