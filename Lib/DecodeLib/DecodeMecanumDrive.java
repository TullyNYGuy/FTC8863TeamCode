...
public class DecodeMecanumDrive implements FTCRobotSubsystem {
    public static class Params {
        ...
        public double lateralInPerTick = .6404; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 15.663;

        // feedforward parameters (in tick units)
        public double kS = .982;
        public double kV = .1933;
        public double kA = .032;
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(DecodeMecanumDrive.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(DecodeMecanumDrive.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(DecodeMecanumDrive.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(DecodeMecanumDrive.this.rightFront));
    ...
    public DecodeMecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
        ...
        leftBack = hardwareMap.get(DcMotorEx.class, "leftRearMotor");
        rightBack = hardwareMap.get(DcMotorEx.class, "rightRearMotor");
