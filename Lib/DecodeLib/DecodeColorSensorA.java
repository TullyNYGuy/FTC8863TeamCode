 ...
 */
public class DecodeColorSensorA {
    ...
    public DecodeColorSensorA(HardwareMap hardwareMap, Telemetry telemetry, String name) {
...
//                0.08f, 0.2f);
        ...
        // access the color sensor through the sensor methods: decodeColorSensorA.sensor.whatever
