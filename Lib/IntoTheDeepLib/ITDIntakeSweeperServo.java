...
public class ITDIntakeSweeperServo implements FTCRobotSubsystem {
    ...
    //*********************************************************************************************
    private CRServo intakeSweeperServo;
    ...
    public ITDIntakeSweeperServo(HardwareMap hardwareMap, Telemetry telemetry) {
        intakeSweeperServo = hardwareMap.get(CRServo.class, "intakeSweeperServo");
        intakeSweeperServo.setDirection(DcMotorSimple.Direction.FORWARD);
