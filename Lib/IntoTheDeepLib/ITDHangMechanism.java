...
public class ITDHangMechanism implements FTCRobotSubsystem {
    ...
    //*********************************************************************************************
    private final String HANG_NAME = ITDRobot.HardwareName.HANG_MECHANISM.hwName;

    private DcMotor8863 leftHangMotor;
    private DcMotor8863 rightHangMotor;
    private ITDArmDeployServoLeft armDeployServoLeft;
    private ITDArmDeployServoRight armDeployServoRight;
    ...
    //hang position
    private double hangPosition = -2.0; // inches
    ...
    // from it
    //*********************************************************************************************
    public ITDHangMechanism(HardwareMap hardwareMap, Telemetry telemetry) {

        // create the motor for the lift
        leftHangMotor = new DcMotor8863(ITDRobot.HardwareName.LEFT_HANG_MOTOR.hwName, hardwareMap, telemetry);
        ...
        rightHangMotor = new DcMotor8863(ITDRobot.HardwareName.RIGHT_HANG_MOTOR.hwName, hardwareMap, telemetry);
        ...
        armDeployServoLeft = new ITDArmDeployServoLeft(hardwareMap, telemetry);
        armDeployServoRight = new ITDArmDeployServoRight(hardwareMap, telemetry);
