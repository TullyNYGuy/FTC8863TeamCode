...
public class ITDGamepadForTest {
    ...
    public ITDGamepadForTest(Gamepad gamepad1, Gamepad gamepad2, ITDRobot robot) {
        this.robot = robot;
...
//        }
        ...
        if (gamepad1a.buttonPress(gamepad1.a)) {
            // this was a new button press, not a button held down for a while
            // put the command to be executed here
            robot.extensionArmIntakeController.resetExtensionArm();
        }
...
//        }
        ...
        if (gamepad2b.buttonPress(gamepad2.b)) {
            robot.intakeBucketController.setupForIntake(8, ITDIntakeArmServo.IntakeHeight.HIGH_ALTITUDE_PREP);
            // this was a new button press, not a button held down for a while
            // put the command to be executed here
        ...
        if (gamepad2a.buttonPress(gamepad2.a)) {
            // this was a new button press, not a button held down for a while
            // put the command to be executed here
            robot.extensionArmIntakeController.useSetupForIntakeForNextBucketClearance(8, ITDIntakeArmServo.IntakeHeight.HIGH_ALTITUDE_PREP);
            ...
            robot.intakeBucketController.intakeHighAltitudeTimed(1500);
        }
        ...
        if (gamepad2DpadDown.buttonPress(gamepad2.dpad_down)) {
            robot.liftBucketArmBucketGateController.lift.setDeliveryHeight(ITDLift.Basket.LOW_TELEOP);
            // this was a new button press, not a button held down for a while
            // put the command to be executed here
