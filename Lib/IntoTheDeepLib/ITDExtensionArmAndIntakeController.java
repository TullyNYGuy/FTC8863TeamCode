...
public class ITDExtensionArmAndIntakeController implements FTCRobotSubsystem {
    ...
    public ITDExtensionArmAndIntakeController(HardwareMap hardwareMap, Telemetry telemetry) {
