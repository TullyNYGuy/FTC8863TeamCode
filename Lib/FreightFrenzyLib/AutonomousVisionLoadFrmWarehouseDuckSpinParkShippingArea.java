...
public class AutonomousVisionLoadFrmWarehouseDuckSpinParkShippingArea implements AutonomousStateMachineFreightFrenzy {
    ...
    public AutonomousVisionLoadFrmWarehouseDuckSpinParkShippingArea(FreightFrenzyRobotRoadRunner robot, FreightFrenzyField field, Telemetry telemetry) {
        this.robot = robot;
        this.field = field;
