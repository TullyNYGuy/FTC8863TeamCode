...
public class PoseStorageFF {
    ...
    public static Pose2d DELIVER_TO_TOP_RED_WALL = new Pose2d();
    ...
    //public static Pose2d DELIVER_TO_HIGH_HUB_BLUE_STORAGE= new Pose2d(-50.32,11.8,Math.toRadians(108));
    ...
    public static Pose2d STORAGE_BLUE = new Pose2d(-62.75, 37.25, Math.toRadians(0)); // <- need test
