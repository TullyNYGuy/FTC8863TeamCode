...
public class PoseStorageFF {
    ...
    public static Pose2d START_POSE_RED_NEAR_WALL = new Pose2d(-17.5, 63.75, Math.toRadians(270));
    public static Pose2d START_POSE_BLUE_NEAR_WALL = new Pose2d(-17.5, -63.75, Math.toRadians(90));
    ...
    public static Pose2d HUB_RED = new Pose2d(-12, 49,Math.toRadians(270));
    public static Pose2d DUCK_SPINNER_RED = new Pose2d(-59.75,56.75,Math.toRadians(90));
    ...
    public static Pose2d HUB_BLUE = new Pose2d(-12, -49,Math.toRadians(90));
    public static Pose2d DUCK_SPINNER_BLUE = new Pose2d(-59.75,-56.75,Math.toRadians(90));
