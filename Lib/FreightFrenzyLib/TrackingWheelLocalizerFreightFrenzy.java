 ...
 */
@Config
public class TrackingWheelLocalizerFreightFrenzy extends ThreeTrackingWheelLocalizer {
    ...
    public TrackingWheelLocalizerFreightFrenzy(HardwareMap hardwareMap) {
        super(Arrays.asList(
