...
public class AutonomousLowLoadDuckSpinParkShippingAreaBlueNearWall implements AutonomousStateMachineFreightFrenzy {
    ...
    public AutonomousLowLoadDuckSpinParkShippingAreaBlueNearWall(FreightFrenzyRobotRoadRunner robot, FreightFrenzyField field, Telemetry telemetry) {
        this.robot = robot;
        this.field = field;
