...
public class AutonomousLowLoadDuckSpinParkShippingAreaRedNearWall implements AutonomousStateMachineFreightFrenzy {
    ...
    public AutonomousLowLoadDuckSpinParkShippingAreaRedNearWall(FreightFrenzyRobotRoadRunner robot, FreightFrenzyField field, Telemetry telemetry) {
        this.robot = robot;
        this.field = field;
