...
public class OdometrySystem {
    ...
    public void cancelOutAngleFromMovement(){
        leftEncoderValueRevised = leftEncoderValue - findArcLength();
        rightEncoderValueRevised = rightEncoderValue - findArcLength();
        backEncoderValueRevised = backEncoderValue - findArcLength();
    }
    public void
    //*********************************************************************************************
    //          MAJOR METHODS
