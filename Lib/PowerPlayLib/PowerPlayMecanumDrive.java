...
import org.firstinspires.ftc.teamcode.Lib.FreightFrenzyLib.TrackingWheelLocalizerFreightFrenzy;
 ...
 */
@Config
public class PowerPlayMecanumDrive extends MecanumDrive implements FTCRobotSubsystem {
    ...
    // from it
    //*********************************************************************************************
    public PowerPlayMecanumDrive(String frontLeftMotorName, String backLeftMotorName, String frontRightMotorName, String backRightMotorName, HardwareMap hardwareMap) {
        ...
        setLocalizer(new PowerPlayTrackingWheelLocalizer(hardwareMap));
    }
