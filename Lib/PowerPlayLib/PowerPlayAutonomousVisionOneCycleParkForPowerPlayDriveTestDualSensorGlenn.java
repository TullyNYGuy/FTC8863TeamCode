...
//                logCommandOnchange.log("pole location = " + robot.poleLocationDetermination.getPoleLocation().toString());
            ...
            case FIXING_POSITION: {
                ...
                double distanceToMove = DistanceUnit.INCH.fromUnit(DistanceUnit.MM, 162 - robot.poleLocationDetermination.getDistanceFromPole(DistanceUnit.MM));
            ...
            case WAIT_FOR_COMPLETE: {
                if (!robot.mecanum.isBusy() && timer.milliseconds() > 5000) {
                    currentState = States.COMPLETE;
