...
public class PowerPlayAutonomousNoVisionParkLocationOneOrThreeStateMachine implements PowerPlayAutonomousStateMachine {
    ...
    public PowerPlayAutonomousNoVisionParkLocationOneOrThreeStateMachine(PowerPlayRobot robot, PowerPlayField field, Telemetry telemetry) {
        this.robot = robot;
        this.field = field;
