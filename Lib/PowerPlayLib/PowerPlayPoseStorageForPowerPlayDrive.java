...
public class PowerPlayPoseStorageForPowerPlayDrive {
    ...
    public static Pose2d RED_LEFT_JUNCTION_POLE_LOCATION = new Pose2d(-11.75, -22, Math.toRadians(270));
    ...
    public static Pose2d RED_RIGHT_PARK_LOCATION_3 = new Pose2d(55.75, -11.75, Math.toRadians(90));
    ...
    public static Pose2d BLUE_LEFT_PARK_LOCATION_3 = new Pose2d(-56.75,-14.75 , Math.toRadians(270));
    //public static Pose2d BLUE_LEFT_JUNCTION_POLE_LOCATION = new Pose2d(-11.75, -23.5, Math.toRadians(270));
    public static Pose2d BLUE_LEFT_JUNCTION_POLE_LOCATION = new Pose2d(-11.75, -22, Math.toRadians(270));
    ...
    public static Pose2d BLUE_RIGHT_PARK_LOCATION_3 = new Pose2d(55.75, -11.75, Math.toRadians(90));
