...
/**
 * This class exists as a way to communicate between the gamepad, speed controller and the teleop
 * opmode. It cannot be part of the gamepad or the speed controller because of the chicken and egg
 * thing. This stuff has to be created before either of them.
 */
public class PowerPlayRobotModes {
