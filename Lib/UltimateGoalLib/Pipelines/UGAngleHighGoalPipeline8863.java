...
public class UGAngleHighGoalPipeline8863 extends UGBasicHighGoalPipeline {
    ...
    public UGAngleHighGoalPipeline8863(double fov, double cameraPitchOffset, double cameraYawOffset) {
        super();
        this.fov = fov;
    ...
    public UGAngleHighGoalPipeline8863(double fov) {
        this(fov, 0, 0);
    }
