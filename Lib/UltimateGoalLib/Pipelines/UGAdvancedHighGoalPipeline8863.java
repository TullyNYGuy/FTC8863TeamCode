...
public class UGAdvancedHighGoalPipeline8863 extends UGAngleHighGoalPipeline8863 {
    ...
    public UGAdvancedHighGoalPipeline8863(double fov, double cameraHeight) {
        this(fov, cameraHeight, 40.625, 0, 0);  // inches
    }

    public UGAdvancedHighGoalPipeline8863(double fov, double cameraHeight, double centerOfLogoHeight,
