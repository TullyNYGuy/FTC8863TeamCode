...
public class TrackWidthTunerUltimateGoal extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        for (int i = 0; i < NUM_TRIALS; i++) {
            ...
            double trackWidth = DriveConstantsUltimateGoal.TRACK_WIDTH * Math.toRadians(ANGLE) / headingAccumulator;
